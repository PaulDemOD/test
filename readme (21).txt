...
Windows PE image. Follow the directions for your operating system.
...
2. Copy all files from the PROXGBWin32NDIS68WinPE directory to the
   temporary directory.
...
2. Copy all files from the "PROXGB\Winx64\NDIS68" directory to the
   temporary directory. Do NOT copy the *ixe68x64.inf* file to this
   directory.
